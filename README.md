...
- **CSS3:** Estilização responsiva, CSS Grid, variáveis CSS e suporte avançado para impressão `@media print`.
- **JavaScript (Vanilla / ES6+):** Lógica pura de cálculo de datas, alternância de cores e renderização sem dependências externas.
